...
class OpportunityResponse(OpportunityBase):
    ...
    target_bid_closing_date: Optional[str] = None
    expected_contract_award_date: Optional[str] = None
    target_issue_date: Optional[str] = None
    ...
    target_bid_closing_date_parsed: Optional[datetime] = None
    expected_contract_award_date_parsed: Optional[datetime] = None
    target_issue_date_parsed: Optional[datetime] = None
